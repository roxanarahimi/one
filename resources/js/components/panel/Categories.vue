                            ...
                            <form>
                                <div class="row">
                                    <div class="col-12 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="title" required = "required" aria-describedby="titleHelp">
                                        <div style="min-height: 10px">
                                            <div v-for="error in errors" id="titleHelp" class="form-text error py-0 my-0">
                                                {{ error }}
                                            </div>
                                        </div>
                                    </div>
